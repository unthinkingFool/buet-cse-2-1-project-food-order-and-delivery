  ...
  return (
    ...
    >
      ...
      <div className="p-3.5">
        ...
        <div className="mt-2">
          <motion.button
            whileHover={isAvailable ? { x: 1, y: 1, boxShadow: "1px 1px 0px 0px #1F2023" } : {}}
            whileTap={isAvailable ? { x: 2, y: 2, boxShadow: "0px 0px 0px 0px #1F2023" } : {}}
            disabled={!isAvailable}
            onClick={() => {
              quantity > 0
                ? dispatch(
            ...
            style={{ boxShadow: isAvailable ? "3px 3px 0px 0px #1F2023" : "none" }}
            className={`${
              !isAvailable
