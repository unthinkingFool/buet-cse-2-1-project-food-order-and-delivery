              ...
              {showinfo && (
                ...
                >
                  ...
                  {/* ===============================================
                      ...
                      (same actions as the "hidden sm:block/sm:flex"
                      buttons above — just re-surfaced here so they
                      remain reachable below the sm breakpoint)
                  ================================================ */}

                  <div className="sm:hidden border-b-2 border-gray-100">
                    {userData?.role === "owner" && restaurantData && (
                      <div
                        onClick={() => {
                          navigate("/add-food");
                          setshowinfo(false);
                    ...
                    {userData?.role === "customer" && (
                      <div
                        ...
                        className="px-3.5 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-[#FF5A36] transition-colors cursor-pointer"
                      >
                        My Orders
                      </div>
                    )}
