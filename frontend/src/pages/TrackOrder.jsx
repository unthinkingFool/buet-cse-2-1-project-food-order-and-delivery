    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center">
        ...
        >
          ...
          <h1 className="text-xl font-black text-[#1F2023] mt-3">
            Order not found
          </h1>
          ...
          <motion.button
            ...
            className="mt-6 bg-[#FF5A36] px-5 py-2.5 text-sm font-bold uppercase tracking-wide text-white cursor-pointer"
          >
            Go Home
          </motion.button>
        </motion.div>
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-[#1F2023] mt-2">
        ...
        <motion.div
          ...
          className="border-2 border-[#1F2023] bg-white p-5 mb-6"
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="h-12 w-12 bg-[#FF5A36]/10 flex items-center justify-center">
              ...
              return (
                <React.Fragment key={status.value}>
                  <div className="flex flex-col items-center">
                    <div
                      className={`h-9 w-9 border-2 border-[#1F2023] flex items-center justify-center ${
                        completed
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wide text-gray-500 mt-2 text-center max-w-[70px]">
                      {status.label}
                    </span>
                  </div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-black text-[#1F2023]">Your Items</h2>
          </div>
          ...
          <div className="space-y-3">
            {order.items.map((item) => (
              <div
                ...
                className="flex items-center gap-3 border-b-2 border-gray-100 pb-3 last:border-0 last:pb-0"
              >
                <img
                  src={item.item_image}
                  alt={item.item_name}
        ...
        {order.rider && (
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-black text-[#1F2023]">Your Rider</h2>
            </div>
            ...
            {order.status === "out_for_delivery" && (
              <div className="mt-4 bg-[#FF5A36]/5 border-2 border-[#FF5A36]/10 p-3">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs font-bold uppercase tracking-wide text-[#1F2023]">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-black text-[#1F2023]">Payment</h2>
          </div>
          ...
          <div className="border-t-2 border-gray-100 mt-4 pt-4 flex items-center justify-between">
        ...
        <div className="text-center text-xs font-bold uppercase tracking-wide text-gray-400 pb-8">
